export const environment = {
  ...
  urlpost: 'http://localhost:3000/api/post_cita_trabajador_cliente',
  urlgetCitasCliente: 'http://localhost:3000/api/get_citas_cliente',
  urlgetCitasTrabajadorDia: 'http://localhost:3000/api/get_citas_trabajador_dia',
