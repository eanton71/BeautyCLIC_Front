export const environment = {
  production:true, 
  url_public: 'http://backend.formactiu.com/assets',
  url_login: 'http://backend.formactiu.com/api/login-user',
  url_register: 'http://backend.formactiu.com/api/register-user',
  url_update_image: 'http://backend.formactiu.com/api/upload/user-pic',
